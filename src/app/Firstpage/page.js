  ...
  return (
    <div>
      <div className="relative">
        <Image src={background} alt="" width={1920} />
        <div className="absolute top-2 left-2 bg-opacity-50 flex justify-start items-start text-black px-2 py-2">
          <div className="flex-col px-12 py-6">
            ...
            <div className="w-1/3 text-base px-2 py-2">
              ...
              transformative journey. As a Student Ambassador, you&apos;ll
              represent the foundation, embody its spirit, and engage in a range
              of activities. This volunteer position offers a unique opportunity
              to enhance leadership, interpersonal, and communication skills
              while contributing to real-life problem-solving.
            </div>
            <div>
